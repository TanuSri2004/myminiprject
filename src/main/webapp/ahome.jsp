<%-- 
    Document   : ahome
    Created on : Jul 12, 2016, 11:55:53 AM
    Author     : java4
--%>
...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
       <ul>
          <li class="active"><a href="ahome.jsp"><span>AuthentiCheck Home</span></a></li>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
            <br><h2>AuthentiCheck Home</h2><br>
         <div class="clr"></div>
         <!---Start Body --->
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
            <li><a href="ahome.jsp"> AuthentiCheck Home</a></li>
