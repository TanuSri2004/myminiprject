<%-- 
    Document   : user_req
    Created on : Jul 12, 2016, 12:15:18 PM
    Author     : java4
--%>
...
<script type="text/javascript" src="js/coin-slider.min.js"></script>
        ...
        <script>alert('Role Based Authorization Key Generation Success and Sent to user Mail ID');</script>
        <%
            }if(request.getParameter("msg1")!=null && request.getParameter("msg1").equalsIgnoreCase("notsame")){
            	out.println(" <script>alert('Role Based Authorization Key Generation Failed....');</script>");
            }
        %>
<body>
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
       <ul>
          <li><a href="ahome.jsp"><span>AuthentiCheck Home</span></a></li>
...
//                                String panme=(String) session.getAttribute("sssname");
                                    ...
                                    try {
                                        ...
                                        <td> <a href="verify.jsp?skey=<%=rs.getString("secret_key")%>&org=<%=rs.getString("oname")%>"><font style="color: green; font-size: 16px">verify and generate</a></font> </td>
                                        <tr />
                                        <%
