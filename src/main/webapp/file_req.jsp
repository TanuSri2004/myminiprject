<%-- 
    Document   : file_req
    Created on : Jul 13, 2016, 3:29:17 PM
    Author     : java4
--%>
...
<html> 
<head>
<title>AuthentiCheck Login Page</title>
                            ...
                            <tr>
                                ...
                                System.out.println("Provider Name"+Pname);
                                    ...
                                    try {
                                        ...
                                        String qq="SELECT *FROM upload WHERE filename LIKE '"+keyword+"%' or provider_name='"+keyword+"%'";
...
<td> <a href="request.jsp?filename=<%=rs.getString("filename")%>&secret_key=<%=rs.getString("secret_key")%>&pname=<%=rs.getString("provider_name")%>&oname=<%=rs.getString(8)%>"><font style="color: green; font-size: 16px">Send</a></font> </td>
                                        <tr />
                                        <%
