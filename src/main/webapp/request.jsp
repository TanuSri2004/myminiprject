...
//           int a1 =(Integer)(session.getAttribute( "id" ));
       ...
       Connection con= DbConnection.getConnection();
        Statement st=con.createStatement();
            ...
            String sql="insert into request(name, email, state, country, title, secret_key, pname, status,oname) values ('"+User_Name+"','"+Email+"','"+State+"','"+Country+"','"+title+"','"+skey+"','"+pname+"','"+Status+"','"+oname+"')";
