...
//                                String panme=(String) session.getAttribute("sssname");
                                	String keyverified=request.getParameter("skey");
                                    Connection con = null;
                                    Statement st = null;
                                    ResultSet rs = null;
                                    try {
                                        ...
                                        rs = st.executeQuery("select * from request where secret_key='"+keyverified+"' and status='No'");
                                        while(rs.next())
                                        ...
                                        <td> <a href="mail.jsp?<%=rs.getString("id")%>"><font style="color: green; font-size: 16px">Send Key</a></font> </td>
                                        <tr />
                                        <%
